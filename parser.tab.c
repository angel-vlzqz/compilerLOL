...
{
      26,     0,    -1,    27,    29,    -1,    28,    27,    -1,    28,
      -1,    10,     9,    17,    -1,    10,     9,    -1,    30,    -1,
      31,    30,    -1,    -1,     9,    11,    32,    17,    -1,     8,
       9,    -1,     4,    32,    23,    29,     5,    29,    -1,     6,
      32,    24,    29,    -1,     7,    32,    17,    -1,    32,    12,
      32,    -1,    32,    13,    32,    -1,    32,    14,    32,    -1,
      32,    15,    32,    -1,    16,    32,    18,    -1,     9,    -1,
       3,    -1
};
...
{
       0,    47,    47,    57,    63,    72,    77,    83,    91,    98,
     104,   118,   129,   136,   142,   150,   158,   166,   174,   181,
     185,   197
};
#endif
...
{
  "$end", "error", "$undefined", "NUMBER", "IF", "ELSE", "WHILE",
  "RETURN", "WRITE", "ID", "TYPE", "ASSIGNOP", "PLUS", "MINUS", "MUL",
  "LOGICOP", "'('", "SEMICOLON", "')'", "'['", "']'", "'{'", "'}'", "THEN",
  "DO", "$accept", "Program", "VarDeclList", "VarDecl", "Block",
  "StmtList", "Stmt", "Expr", 0
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
     ...
     265,   266,   267,   268,   269,   270,    40,   271,    41,    91,
      93,   123,   125,   272,   273
};
# endif
...
{
      -3,     0,    10,    35,    -3,    -5,   -27,    -1,    -1,    -1,
       4,     3,   -27,   -27,    35,   -27,   -27,   -27,   -27,    -1,
      15,    11,    33,   -27,    -1,   -27,    19,    -1,    -1,    -1,
      -1,    35,    35,   -27,    39,   -27,   -11,   -11,    21,    45,
      13,   -27,   -27,    35,   -27
};
...
{
      21,    22,    17,    29,    30,    40,    41,     1,    18,     5,
       6,    26,    16,    23,    24,    19,    34,    44,    43,    36,
      37,    38,    39,    27,    28,    29,    30,    27,    28,    29,
      30,    27,    28,    29,    30,    32,    30,    35,    31,     7,
      15,     8,     9,    10,    11,    27,    28,    29,    30,     0,
      33,    27,    28,    29,    30,    25,    42,    27,    28,    29,
      30
};

static const yytype_int8 yycheck[] =
{
       8,     9,     3,    14,    15,    31,    32,    10,     9,     9,
       0,    19,    17,     9,    11,    16,    24,    43,     5,    27,
      28,    29,    30,    12,    13,    14,    15,    12,    13,    14,
      15,    12,    13,    14,    15,    24,    15,    18,    23,     4,
       4,     6,     7,     8,     9,    12,    13,    14,    15,    -1,
      17,    12,    13,    14,    15,    14,    17,    12,    13,    14,
      15
};
...
static const yytype_uint8 yystos[] =
{
       ...
       8,     9,    29,    30,    31,    27,    17,     3,     9,    16,
      32,    32,    32,     9,    11,    30,    32,    12,    13,    14,
      15,    23,    24,    17,    32,    18,    32,    32,    32,    32,
      29,    29,    17,     5,    29
};
...
#line 63 "parser.y"
    {
        ...
        (yyval.ast) = createNode(NodeType_VarDeclList);
        (yyval.ast)->varDeclList.varDecl = (yyvsp[(1) - (1)].ast);
...
#line 83 "parser.y"
	...
	(yyval.ast) = createNode(NodeType_Block);
        (yyval.ast)->block.stmtList = (yyvsp[(1) - (1)].ast);
    ;}
    break;
...
#line 104 "parser.y"
    {
        Symbol* existingSymbol = findSymbol(symTab, (yyvsp[(1) - (4)].string));
        if (existingSymbol != NULL) {
            ...
            (yyval.ast)->assignStmt.operator = strdup((yyvsp[(2) - (4)].operator));
...
#line 118 "parser.y"
    {
        Symbol* existingSymbol = findSymbol(symTab, (yyvsp[(2) - (2)].string));
        if (existingSymbol != NULL) {
            printf("Parsed Write Statement: %s\n", (yyvsp[(2) - (2)].string));
            (yyval.ast) = createNode(NodeType_WriteStmt);
            (yyval.ast)->writeStmt.varName = strdup((yyvsp[(2) - (2)].string));
        } else {
            printf("Error: Variable %s not declared\n", (yyvsp[(2) - (2)].string));
            yyerror("Undeclared variable");
        }
...
#line 129 "parser.y"
    {
        ...
        (yyval.ast)->ifStmt.condition = (yyvsp[(2) - (6)].ast);
        (yyval.ast)->ifStmt.thenBlock = (yyvsp[(4) - (6)].ast);
        (yyval.ast)->ifStmt.elseBlock = (yyvsp[(6) - (6)].ast);
    ;}
    break;
...
#line 136 "parser.y"
    {
        ...
        (yyval.ast)->whileStmt.condition = (yyvsp[(2) - (4)].ast);
        (yyval.ast)->whileStmt.block = (yyvsp[(4) - (4)].ast);
    ;}
    break;
...
#line 174 "parser.y"
    {
        printf("Parsed Logical Expression: %s %s %s\n", (yyvsp[(1) - (3)].ast), (yyvsp[(2) - (3)].operator), (yyvsp[(3) - (3)].ast));
        (yyval.ast) = createNode(NodeType_LogicalOp);
        (yyval.ast)->logicalOp.logicalOp = strdup((yyvsp[(2) - (3)].operator));  // Store the operator string
        (yyval.ast)->logicalOp.left = (yyvsp[(1) - (3)].ast);
        (yyval.ast)->logicalOp.right = (yyvsp[(3) - (3)].ast);
    ;}
    break;
...
#line 185 "parser.y"
    {
        Symbol* existingSymbol = findSymbol(symTab, (yyvsp[(1) - (1)].string));
        if (existingSymbol != NULL) {
