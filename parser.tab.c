...
{
      -2,    -7,    36,     6,    -2,    38,   -26,     0,     0,     0,
      44,    45,   -26,   -26,     6,   -26,   -26,   -26,   -26,     0,
      15,    11,    27,   -26,     0,   -26,    19,     0,     0,     0,
       0,     6,     6,   -26,    32,   -26,   -10,   -10,    40,    37,
      52,   -26,   -26,     6,   -26
};
...
{
      21,    22,     5,    17,    29,    30,    40,    41,     1,    18,
       7,    26,     8,     9,    10,    11,    34,    19,    44,    36,
      37,    38,    39,    27,    28,    29,    30,    27,    28,    29,
      30,    27,    28,    29,    30,    32,     6,    35,    31,    27,
      28,    29,    30,    33,    27,    28,    29,    30,    42,    27,
      28,    29,    30,    23,    16,    30,    24,    43,    15,     0,
      25
};

static const yytype_int8 yycheck[] =
{
       8,     9,     9,     3,    14,    15,    31,    32,    10,     9,
       4,    19,     6,     7,     8,     9,    24,    17,    43,    27,
      28,    29,    30,    12,    13,    14,    15,    12,    13,    14,
      15,    12,    13,    14,    15,    24,     0,    18,    23,    12,
      13,    14,    15,    16,    12,    13,    14,    15,    16,    12,
      13,    14,    15,     9,    16,    15,    11,     5,     4,    -1,
      14
};
...
#line 118 "parser.y"
        ...
        if (existingSymbol != NULL) {
            ...
            (yyval.ast)->writeStmt.varName = strdup((yyvsp[0].string));
        } else {
            printf("Error: Variable %s not declared\n", (yyvsp[0].string));
            yyerror("Undeclared variable");
        }
