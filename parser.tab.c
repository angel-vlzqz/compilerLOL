...
{
       0,    51,    51,    62,    69,    79,    87,    94,   103,   112,
     118,   152,   167,   175,   182,   191,   200,   209,   218,   226,
     231,   247
};
#endif
...
static const char *const yytname[] =
{
  ...
  "WHILE", "RETURN", "WRITE", "ID", "TYPE", "ASSIGNOP", "PLUS", "MINUS",
  "MUL", "LOGICOP", "SEMICOLON", "'('", "')'", "'['", "']'", "'{'", "'}'",
  "THEN", "DO", "$accept", "Program", "VarDeclList", "VarDecl", "Block",
...
{
      -6,    44,     2,     6,    -6,    20,   -27,     0,     0,     0,
      45,    46,   -27,   -27,     6,   -27,   -27,   -27,   -27,     0,
      15,    11,    27,    39,     0,   -27,    19,     0,     0,     0,
       0,     6,     6,   -27,   -27,    32,   -27,    -7,    -7,    41,
      37,    53,   -27,   -27,     6,   -27
};
...
{
       0,     0,     0,     9,     4,     6,     1,     0,     0,     0,
       0,     0,     2,     7,     9,     3,     5,    21,    20,     0,
       0,     0,     0,     0,     0,     8,     0,     0,     0,     0,
       0,     9,     9,    14,    11,     0,    19,    15,    16,    17,
      18,     0,    13,    10,     9,    12
};
...
{
      21,    22,     6,    17,     1,    41,    42,    29,    30,    18,
       7,    26,     8,     9,    10,    11,    35,    19,    45,    37,
      38,    39,    40,    27,    28,    29,    30,    27,    28,    29,
      30,    27,    28,    29,    30,    32,    16,    36,    31,    27,
      28,    29,    30,    33,    27,    28,    29,    30,    43,    27,
      28,    29,    30,     5,    23,    34,    30,    24,    44,    15,
       0,    25
};

static const yytype_int8 yycheck[] =
{
       8,     9,     0,     3,    10,    31,    32,    14,    15,     9,
       4,    19,     6,     7,     8,     9,    24,    17,    44,    27,
      28,    29,    30,    12,    13,    14,    15,    12,    13,    14,
      15,    12,    13,    14,    15,    24,    16,    18,    23,    12,
      13,    14,    15,    16,    12,    13,    14,    15,    16,    12,
      13,    14,    15,     9,     9,    16,    15,    11,     5,     4,
      -1,    14
};
...
{
       0,    10,    26,    27,    28,     9,     0,     4,     6,     7,
       8,     9,    29,    30,    31,    27,    16,     3,     9,    17,
      32,    32,    32,     9,    11,    30,    32,    12,    13,    14,
      15,    23,    24,    16,    16,    32,    18,    32,    32,    32,
      32,    29,    29,    16,     5,    29
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* Program: VarDeclList Block  */
#line 52 "parser.y"
    {
        ...
        root->program.block = (yyvsp[0].ast);
    }
...
#line 70 "parser.y"
    {
        ...
        (yyval.ast) = createNode(NodeType_VarDeclList);
        (yyval.ast)->varDeclList.varDecl = (yyvsp[0].ast);
...
#line 80 "parser.y"
    {
        ...
        insertSymbol(symTab, (yyvsp[-1].string), (yyvsp[-2].string));
    }
...
#line 1184 "parser.tab.c"
  ...
  case 7: /* Block: StmtList  */
#line 95 "parser.y"
    {
        printf("Parsed Block\n");
	    (yyval.ast) = createNode(NodeType_Block);
        (yyval.ast)->block.stmtList = (yyvsp[0].ast);
    }
...
#line 1214 "parser.tab.c"
  ...
  case 10: /* Stmt: ID ASSIGNOP Expr SEMICOLON  */
#line 119 "parser.y"
    {
        Symbol* existingSymbol = findSymbol(symTab, (yyvsp[-3].string));
        if (existingSymbol != NULL) 
        {
            ...
            if ((yyvsp[-1].ast)->type == NodeType_SimpleExpr) 
            {
                snprintf(valueBuffer, sizeof(valueBuffer), "%d", (yyvsp[-1].ast)->simpleExpr.number);
            } 
            else 
            {
            ...
            updateSymbolValue(symTab, (yyvsp[-3].string), valueBuffer);
...
#line 1252 "parser.tab.c"
  ...
  case 11: /* Stmt: WRITE ID SEMICOLON  */
#line 153 "parser.y"
    {
        Symbol* existingSymbol = findSymbol(symTab, (yyvsp[-1].string));
        if (existingSymbol != NULL) 
        {
...
#line 1271 "parser.tab.c"
  ...
  case 12: /* Stmt: IF Expr THEN Block ELSE Block  */
#line 168 "parser.y"
    {
        printf("Parsed If-Else Statement\n");
        (yyval.ast) = createNode(NodeType_IfStmt);
        (yyval.ast)->ifStmt.condition = (yyvsp[-4].ast);
        (yyval.ast)->ifStmt.thenBlock = (yyvsp[-2].ast);
        (yyval.ast)->ifStmt.elseBlock = (yyvsp[0].ast);
    }
#line 1283 "parser.tab.c"
    break;

  case 13: /* Stmt: WHILE Expr DO Block  */
#line 176 "parser.y"
    {
        printf("Parsed While Statement\n");
        (yyval.ast) = createNode(NodeType_WhileStmt);
        (yyval.ast)->whileStmt.condition = (yyvsp[-2].ast);
        (yyval.ast)->whileStmt.block = (yyvsp[0].ast);
    }
...
#line 1343 "parser.tab.c"
  ...
  case 18: /* Expr: Expr LOGICOP Expr  */
#line 219 "parser.y"
    {
        printf("Parsed Logical Expression: %s %s %s\n", (yyvsp[-2].ast), (yyvsp[-1].operator), (yyvsp[0].ast));
        (yyval.ast) = createNode(NodeType_LogicalOp);
        (yyval.ast)->logicalOp.logicalOp = strdup((yyvsp[-1].operator));  // Store the operator string
        (yyval.ast)->logicalOp.left = (yyvsp[-2].ast);
        (yyval.ast)->logicalOp.right = (yyvsp[0].ast);
    }
...
#line 232 "parser.y"
    {
        Symbol* existingSymbol = findSymbol(symTab, (yyvsp[0].string));
        if (existingSymbol != NULL) 
        {
